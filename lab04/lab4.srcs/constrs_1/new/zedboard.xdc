...
# set_property -dict {PACKAGE_PIN T22 IOSTANDARD LVCMOS33} [get_ports {usr_led[0]}]
# set_property -dict {PACKAGE_PIN T21 IOSTANDARD LVCMOS33} [get_ports {usr_led[1]}]
# set_property -dict {PACKAGE_PIN U22 IOSTANDARD LVCMOS33} [get_ports {usr_led[2]}]
# set_property -dict {PACKAGE_PIN U21 IOSTANDARD LVCMOS33} [get_ports {usr_led[3]}]
...
# set_property PACKAGE_PIN P16 [get_ports {usr_btn[0]}];  # "BTNC"
# set_property PACKAGE_PIN R16 [get_ports {usr_btn[3]}];  # "BTND"
# set_property PACKAGE_PIN N15 [get_ports {usr_btn[4]}];  # "BTNL"
# set_property PACKAGE_PIN R18 [get_ports {usr_btn[2]}];  # "BTNR"
# set_property PACKAGE_PIN T18 [get_ports {usr_btn[1]}];  # "BTNU"

# set_property -dict { PACKAGE_PIN P16  IOSTANDARD LVCMOS33 } [get_ports { BTNC }];
# set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {usr_btn[2]}]
# set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {usr_btn[3]}]
# set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {usr_btn[1]}]
# set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports {usr_btn[0]}]
